...
interface OrderUpdateStatusConfirmModalProps {
  isOpen: boolean;
  title: string;
  message: string;
  confirmText?: string;
...
export const OrderUpdateStatusConfirmModal = ({
  isOpen,
  title,
  message,
  confirmText = "Confirm",
  ...
  onConfirm,
  onCancel,
}: OrderUpdateStatusConfirmModalProps) => {
        ...
        <div className="flex flex-col items-center text-center gap-3">
          ...
          <div
            className={`w-14 h-14 rounded-full flex items-center justify-center ${
              isDestructive ? "bg-red-100 text-red-500" : "bg-primary-orange-main/10 text-primary-orange-main"
            }`}
          >
            {isDestructive ? (
