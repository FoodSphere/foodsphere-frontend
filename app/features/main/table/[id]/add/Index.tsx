...
import { TableOrderAddSidebarComponent, OrderItem } from "@/app/components/featureComponents/TableOrderSidebarComponent";
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col mr-[400px]">
      ...
      <div className="bg-white shadow-sm py-4 px-6 flex items-center space-x-4">
        ...
        <h1 className="text-3xl font-bold flex items-center gap-2">
            Menu <span className="bg-primary-orange-main text-white px-3 py-1 rounded-lg text-2xl">Table {tableId}</span>
        </h1>
      </div>
